...
# 阿茲海默症分析資料庫 - Web 版本啟動腳本

echo "🧠 阿茲海默症分析資料庫 - Web 版本"
echo "=================================="
...
echo ""
echo "📁 檢查資料檔案..."
csv_file="data/alzheimers_cohort_v1/113.csv"
if [ -f "$csv_file" ]; then
...
echo ""
echo "📦 檢查依賴套件..."
if python3 -c "import pandas, matplotlib, numpy, openpyxl, requests, flask" 2>/dev/null; then
    echo "  ✅ 所有依賴套件已安裝"
else
    echo "  ⚠️  缺少依賴套件，正在安裝..."
...
echo "📊 API 端點: http://localhost:5001/api/analyze"
echo ""
echo "按 Ctrl+C 停止服務器"
echo "=================================="
